    ...
    def run(self, example: QAExample) -> RunRecord:
        ...
        for attempt_id in range(1, self.max_attempts + 1):
            ...
            if self.agent_type == "reflexion" and attempt_id < self.max_attempts:
                reflection, tokens_ref, latency_ref = reflector(example, attempt_id, judge)
                token_estimate += tokens_ref
        ...
        failure_mode = "none" if final_score == 1 else FAILURE_MODE_BY_QID.get(base_qid, "wrong_final_answer")
